...
route.post("/api/formularios", (req, res) =>
  formularioController.cadastrarFormulario(req, res)
);
route.get("/api/formularios", (req, res) =>
  formularioController.listarFormularios(req, res)
);
route.get("/api/formularios/ativos", (req, res) =>
  formularioController.listarFormulariosAtivos(req, res)
);
...
route.delete("/api/formularios/:id", (req, res) =>
  formularioController.excluirFormulario(req, res)
);
