...
route.get('/servico/usuario/:id', (req, res) => {servicoController.InnerJoinPegaServicoUsuarioPorId(req, res)});
route.get('/servico/categoria', (req, res) => {servicoController.InnerJoinPegaServicoCategoria(req, res)});
route.get('/servico/categoria/:id', (req, res) => {servicoController.InnerJoinPegaServicoCategoriaPorId(req, res)});
